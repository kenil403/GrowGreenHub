...
const recommendedPlants = [
  ...
  { id: 3, title: "Marigold - Bright Yellow", price: 149, image: "/assets/images/Marigold.png", category: "Flowering Plants", description: "Bright yellow marigolds to brighten your garden" },
];
...
const Product = () => {
  ...
  const isSameProduct = (wishlistItem, selectedProduct) => {
    if (!wishlistItem || !selectedProduct) return false;
    return String(wishlistItem.id) === String(selectedProduct.id);
  };
  ...
  const toggleWishlist = (product) => {
    const isInWishlist = wishlist.some((item) => isSameProduct(item, product));
    if (!isInWishlist) {
